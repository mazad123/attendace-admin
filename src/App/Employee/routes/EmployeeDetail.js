...
import ViewPersonalDetails from './ViewEmployee/ViewPersonalDetails';
import ViewSalaryDetails from './ViewEmployee/ViewSalaryDetails';
import ViewVerificationDetails from './ViewEmployee/ViewVerificationDetails';
              ...
              <div className="d-flex align-items-start row employee_details_data">
                ...
                <div className="tab-content  col-lg-8 tab_minheight" id="v-pills-tabContent">
                  <div className="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                    <ViewEmployeeDetails callback={handleJoiningDate} />
                  </div>
                  ...
                  <div className="tab-pane fade" id="v-pills-salary" role="tabpanel" aria-labelledby="v-pills-salary-tab">
                    <ViewSalaryDetails  dateOfJoining = {userJoiningDate} />
                  </div>
