...
function ViewForm() {
  ...
  const formData = async () => {
    try {
      setLoading(true);
      const result = await httpClient.get(FORMS.GET_USER_FORM_DATA_BY_FORM_ID.replace('{formId}', formId));
